...
const socket = io(process.env.REACT_APP_URL_BE);
...
export {
    ...
    handledisconnect, handleAcctiveDisconnect, handlsendmessange, handlesendtext, handlesendaddgroup,
    handleactionaddgroup, handlsendmessangeingroup, handlerefreshMessangeingroup, handlerefreshMessangesennder,
    handleuserjoingroup, handleuserleavegroup
}